...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'src.utils.follow_up',
        'src.utils.image_gen',
        'src.utils.json_export',
        'src.utils.monthly_report',
        'src.utils.remote_diagnose',
        'src.utils.shipment_flow',
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
